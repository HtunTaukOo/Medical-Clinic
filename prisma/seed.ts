    ...
    create: {
      ...
      doctorProfile: {
        create: {
          ...
          shifts: {
            create: [1, 2, 3, 4, 5].map((weekday) => ({ weekday, startTime: "08:00", endTime: "17:00" })),
          },
          experienceYears: 12,
    ...
    create: {
      ...
      doctorProfile: {
        create: {
          ...
          workingDays: [1, 2, 3, 4, 5],
          shifts: {
            create: [1, 2, 3, 4, 5].map((weekday) => ({ weekday, startTime: "09:00", endTime: "16:00" })),
          },
          experienceYears: 18,
    ...
    create: {
      ...
      doctorProfile: {
        create: {
          ...
          shifts: {
            create: [1, 2, 3, 4, 5, 6].map((weekday) => ({ weekday, startTime: "08:30", endTime: "15:30" })),
          },
          experienceYears: 9,
    ...
    create: {
      ...
      doctorProfile: {
        create: {
          ...
          shifts: {
            create: [2, 3, 4, 5, 6].map((weekday) => ({ weekday, startTime: "10:00", endTime: "18:00" })),
          },
          experienceYears: 7,
